const ticketChannelData = require('../../database/guildData/ticket');
const guildModel = require("../../database/guildData/ticket");
const ticketModel = require("../../database/guildData/ticket")
